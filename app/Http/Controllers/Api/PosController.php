...
class PosController extends Controller
{
    ...
    public function SearchOrderDate(Request $request){
        ...
        $newdate = new DateTime($orderdate);//datetime function er maddhome format chance kora hy//change korar jonno object baniea nilam
        $done = $newdate->format('d/m/Y'); //uporer line bollam ki cahnge korbo //r ei line e change korlam
