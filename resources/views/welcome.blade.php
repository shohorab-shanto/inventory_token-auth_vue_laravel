...
<head>
  ...
  <!-- for default css and js -->
  <link rel="stylesheet" type="text/css" href="{{asset('css/app.css')}}">


  <link href="{{asset('backend/img/logo/logo.png')}}" rel="icon">
  <title>Shohorab Shanto</title>
...
<body id="page-top">
    ...
    <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true" style="display: none">
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
              ...
              <div class="sidebar-brand-text mx-3">Shohorab Ahmed</div>
            </a>
  ...
  <script type="text/javascript">
    ...
    if(token){
        $("#topbar").css("display","");
        $("#sidebar").css("display","");  //style none er jygay none sore jabe and sidebar and top bar show korbe
    }
  </script>
